...
export const getDataFromMock = (): RawSchedule[][] => {
  ...
  const day1: RawSchedule[] = [
    ...
    },
    {
      Horario: '19:00',
      'Tipo de actividad': 'charla',
      'Nombre de la actividad': 'El Futuro del Cómic Digital',
      Descripción: 'Tendencias y oportunidades en la era digital',
      Encargado: 'Tech Comics Lab',
      'Duración (min)': '60',
      RRSS: 'https://twitter.com/techcomicslab',
    },
    {
      Horario: '20:15',
      'Tipo de actividad': 'lanzamiento',
      'Nombre de la actividad': 'Antología "Voces Urbanas"',
      Descripción: 'Lanzamiento de antología de cómics urbanos chilenos',
      Encargado: 'Colectivo Urbano',
      'Duración (min)': '30',
      RRSS: 'https://facebook.com/colectivourbano',
    },
    {
      Horario: '21:00',
      'Tipo de actividad': 'taller',
      'Nombre de la actividad': 'Creación de Storyboard',
      Descripción: 'Planificación visual de historias mediante storyboards',
      Encargado: 'Sofía Martinez',
      'Duración (min)': '90',
      RRSS: 'https://instagram.com/sofia_storyboard',
    },
    {
      Horario: '22:45',
      'Tipo de actividad': 'charla',
      'Nombre de la actividad': 'Monetización del Arte Independiente',
      Descripción:
        'Estrategias para generar ingresos como artista independiente',
      Encargado: 'Business Art Collective',
      'Duración (min)': '75',
      RRSS: 'https://twitter.com/businessart',
    },
  ]
  ...
  const day2: RawSchedule[] = [
    ...
    },
    {
      Horario: '19:00',
      'Tipo de actividad': 'lanzamiento',
      'Nombre de la actividad': 'Revista "Ilustración Chilena"',
      Descripción: 'Lanzamiento del primer número de la revista especializada',
      Encargado: 'Revista Ilustración',
      'Duración (min)': '30',
      RRSS: 'https://twitter.com/revistailus',
    },
    {
      Horario: '20:00',
      'Tipo de actividad': 'charla',
      'Nombre de la actividad': 'Marketing para Artistas',
      Descripción: 'Estrategias de promoción y construcción de marca personal',
      Encargado: 'Marketing Creativo',
      'Duración (min)': '90',
      RRSS: 'https://instagram.com/marketingcreativo',
    },
    {
      Horario: '21:45',
      'Tipo de actividad': 'taller',
      'Nombre de la actividad': 'Composición y Encuadre',
      Descripción: 'Técnicas de composición visual para páginas de cómic',
      Encargado: 'Visual Composition Lab',
      'Duración (min)': '105',
      RRSS: 'https://facebook.com/visualcomplab',
    },
    {
      Horario: '23:00',
      'Tipo de actividad': 'lanzamiento',
      'Nombre de la actividad': 'Antología "Nuevas Voces"',
      Descripción: 'Presentación de antología de artistas emergentes',
      Encargado: 'Plataforma Emergente',
      'Duración (min)': '60',
      RRSS: 'https://instagram.com/emergenteart',
      Información: 'Evento de cierre',
    },
  ]
